...
import AddRevision from './components/author/AddRevision';
    ...
    <div>
      ...
      <main>
        ...
        <Switch>
          ...
          <PrivateRoute exact path='/author/revision/:submissionId' component={AddRevision} roles={[UserRoles.AUTHOR]} />
